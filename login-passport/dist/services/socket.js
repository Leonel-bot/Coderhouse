...
var webSocketServer = (0, _socket["default"])(_server["default"]);
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 2:
              chats = _context.sent;
              res = (0, _chats.normalizrChats)(chats);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            author = {
              email: data.id,
              nombre: _faker.faker.name.firstName(),
              apellido: _faker.faker.name.lastName(),
              edad: _faker.faker.datatype.number(100),
              alias: _faker.faker.name.firstName(),
            ...
            _context2.next = 4;
            return (0, _chats.saveChat)(chat);

          case 4:
            _context2.next = 6;
            return (0, _chats.getChat)();
