...
app.set('views', viewsPath); //Iniciar passport

app.use(_passport["default"].initialize());
app.use(_passport["default"].session());

_passport["default"].use('login', _auth.userLogin);

_passport["default"].use('signup', _auth.userSignup);

app.get('/', _middleware.authMiddleware, /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var products, chats, username;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return (0, _products.get)();
...
app.post('/login', _passport["default"].authenticate('login', {}), function (req, res) {
  res.json({
    msg: 'wellcome'
  });
});
